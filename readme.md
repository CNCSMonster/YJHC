...
### 开发过程
 ...
 7. 准备token读取器(提供函数翻译需要的api,以及缓冲保存token的数据结构)
 ...
 8. 准备局部变量表数据结构(可变结构,能够维护变量的作用域属性,而且能够快速建立和结束作用域)

 9. 准备全局变量表和常量表(在函数解释过程中不会改动,要求能够快速根据名查找)

10. 准备自定义类型表(读取后不会改动,yjhc中放弃支持函数内结构体定义)

11. 函数翻译,把yjhc的语法翻译成c的语法
